...
const styles = StyleSheet.create({ container: { flex: 1, backgroundColor: '#fff' }, content: { flexGrow: 1, justifyContent: 'center', padding: 20 }, title: { fontSize: 48, fontWeight: 'bold', textAlign: 'center', marginBottom: 8 }, titleAccent: { backgroundColor: '#000', color: '#fff', paddingHorizontal: 8 }, subtitle: { fontSize: 24, fontWeight: 'bold', textAlign: 'center', marginBottom: 40 }, form: { gap: 16 }, input: { borderWidth: 2, borderColor: '#000', padding: 16, fontSize: 16 }, button: { backgroundColor: '#000', padding: 16, alignItems: 'center', borderWidth: 2, borderColor: '#000' }, buttonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' }, link: { textAlign: 'center', fontSize: 14, marginTop: 8 }, linkBold: { fontWeight: 'bold', textDecorationLine: 'underline' } });
